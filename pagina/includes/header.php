<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/contatoestilo.css" />
        <link rel="stylesheet" href="assets/img/imgviagem.jpeg" />
    </head>
    <body>
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/img/imgviagem.jpeg" alt="Primeiro Slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="assets/img/img2.jpeg" alt="Segundo Slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="assets/img/img3.jpeg" alt="Terceiro Slide">
                    </div>
                </div>
            </div>
            <div><img src="" alt="" />
